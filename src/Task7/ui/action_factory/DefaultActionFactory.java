package Task7.ui.action_factory;

import Task7.model.DataManager;
import Task7.ui.actions.IAction;
import Task7.ui.actions.book.*;
import Task7.ui.actions.completed_orders.ShowCompletedOrdersCountAction;
import Task7.ui.actions.completed_orders.ShowTotalRevenueAction;
import Task7.ui.actions.completed_orders.SortCompletedOrdersByDateAction;
import Task7.ui.actions.completed_orders.SortCompletedOrdersByPriceAction;
import Task7.ui.actions.csv.book.ExportBookAction;
import Task7.ui.actions.csv.book.ImportBooksAction;
import Task7.ui.actions.csv.customer.ExportCustomerAction;
import Task7.ui.actions.csv.customer.ImportCustomerAction;
import Task7.ui.actions.csv.order.ExportOrderAction;
import Task7.ui.actions.csv.order.ImportOrderAction;
import Task7.ui.actions.csv.request.ExportRequestAction;
import Task7.ui.actions.csv.request.ImportRequestAction;
import Task7.ui.actions.customer.ShowAllCustomer;
import Task7.ui.actions.order.*;
import Task7.ui.actions.request.CreateBookRequestAction;
import Task7.ui.actions.request.ShowAllBookRequestsAction;
import Task7.ui.actions.request.SortRequestsByCountAction;
import Task7.ui.actions.request.SortRequestsByTitleAction;
